    ...
    <div class="row">
        <div class="col-4 col-m-4 col-sm-4">
            ...
            <p><i class="fas fa-coins"></i></p>
                    ...
                    <p style="font-size: 1.2em;"><?php echo $today_expense ?></p>
                </div>
            </div>
        </div>
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card">
                <div class="counter bg-tan">
                <p><i class="fas fa-coins"></i></p>
                    <h3>Yesterday's Expenses</h3>
                    <p style="font-size: 1.2em;"><?php echo $Yesterday_expense ?></p>
                </div>
            </div>
        </div>
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card">
                <div class="counter bg-tan">
                <p><i class="fas fa-coins"></i></p>
                    <h3>Last 7 day's Expenses</h3>
                    <p style="font-size: 1.2em;"><?php echo $week_expense ?></p>
                </div>
            </div>
        </div>
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card">
                ...
                <p><i class="fas fa-coins"></i></p>
                    ...
                    <p style="font-size: 1.2em;"><?php echo $monthly_expense ?></p>
                </div>
            </div>
        </div>
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card">
                <div class="counter bg-tan">
                <p><i class="fas fa-coins"></i></p>
                    <h3>Monthly Budget Left</h3>
                    <p style="font-size: 1.2em;"><?php echo $budget_left ?></p>
                </div>
            </div>
        </div>
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card">
                ...
                <p><i class="fas fa-coins"></i></p>
                    ...
                    <p style="font-size: 1.2em;"><?php echo $total_expenses ?></p>
                </div>
            </div>
        </div>
    </div>
